...
### - Fichier d'origine : ../plugins/auto/msie_compat/plugin.xml
...
# svn add lang/paquet-msie_compat_fr.php lang/paquet-msie_compat_en.php lang/paquet-msie_compat_de.php
