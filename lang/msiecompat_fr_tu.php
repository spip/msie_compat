...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// C
	'choix_explication' => '<p>Cette configuration vous permet d’am&eacute;liorer la compatibilit&eacute; du site public avec le navigateur Internet Explorer.</p>
   <ul>
   ...
   <li>IE7-squish corrige trois bugs de MSIE&nbsp;6 (notamment la double marge des &eacute;l&eacute;ments flottants), mais des effets ind&eacute;sirables peuvent appara&icirc;tre (le webmestre doit v&eacute;rifier la compatibilit&eacute;).</li>
	...
	'choix_non' => 'Ne pas activer&nbsp;: ne rien ajouter &agrave; mes squelettes',
	'choix_titre' => 'Compatibilit&eacute; Microsoft Internet Explorer'
);
