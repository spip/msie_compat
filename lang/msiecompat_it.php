...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// C
	'choix_explication' => '<p>Questa configurazione ti consente di migliorare la compatibilit&agrave; del sito pubblico con il browser Internet Explorer.</p>
   <ul>
   ...
   <li>IE7-squish corregge tre bug di MSIE&nbsp;6 (in particolare il doppio margine degli elementi float), ma possono verificarsi degli effetti collaterali (il webmaster deve verificarne la compatibilit&agrave;).</li>
   </ul>',
	'choix_non' => 'Non attivare: non aggiungere niente ai miei modelli',
	'choix_titre' => 'Compatibilit&agrave; Microsoft Internet Explorer'
);
