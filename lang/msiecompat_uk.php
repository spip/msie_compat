...
// extrait automatiquement de http://trad.spip.net/tradlang_module/msiecompat?lang_cible=uk
...
<li>IE7-squish виправляє три помилки в  MSIE 6 (включаючи подвоєння margin у floating елементів), але може проявлятися side effects.</li>
	...
	'choix_ie7' => '<a href=\'http://code.google.com/p/ie7-js/\'>IE7.js</a> виправляє проблему з прозорістью png файлів і додає селектори CCS2 для ИЕ 5 і ИЕ6  (<a href=\'http://ie7-js.googlecode.com/svn/test/index.html\'> ви можете подивитися список доступних селекторів</a>).',
	'choix_ie7squish' => 'IE7-squish виправляє три основних бага ИЕ 6 (включаючи подвоєння отступів у floating елементів), але може проявлятися side effect.',
	'choix_ie8' => 'IE8.js доповнює IE7.js розширюючи можливості використовувати селекторе CSS від IE 5 до IE 7.',
	...
	'choix_titre' => 'Сувмісність з Internet Explorer (iepngfix)'
);
